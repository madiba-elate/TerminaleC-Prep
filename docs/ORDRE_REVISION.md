# 🎯 Ordre de révision — Terminale C (objectif 18/20 = 558/620)

> Rappel : 31 coefs = **620 pts**. Chaque point gagné en Maths vaut ×7, en Physique ×6.
> Estimations d'heures = ordres de grandeur pour **ton profil** (scientifique, bon en anglais, code déjà).

## 1. Difficulté (plus facile → plus difficile)
...
| 8 | 🏃 EPS (coef 2) | Théorie facile ; pratique variable selon l'épreuve |
...
1. 💻 **Info** — programme court, dashboard bouclé en 1 envoi
2. 🇬🇧 **Anglais** — idem (+ tenses déjà en stock)
3. 🧪 **Chimie** — petit programme, gros ratio
4. 🧬 **SVT**
5. 📐 **Maths** — par chapitres, en priorité le chapitre du moment en classe
6. ⚡ **Physique** — par chapitres, idem
7. 📚 **Littérature** — + titres des œuvres au programme
8. 📖 **Français**
9. 🤔 **Philo**
10. 🏃 **EPS** — fiches théorie d'abord
11. 🔨 **TM**

ECM ✅ et Géographie ✅ : déjà reçus (reste à recevoir leurs cours).

## 5. Règle d'or (travail quotidien, indépendante de l'ordre d'envoi)

- **Chaque jour :** cours du jour en **Maths + Physique** (fiches + exos, jamais de retard).
- **+ 1 créneau « quick win »** (bloc sécurisé : ECM, Info, Anglais, Géo) pour engranger les points faciles des devoirs S1-S6.
- **Week-end 7h30 :** 1 chapitre Maths ou Physique à fond + 1 matière du bloc méthode en rotation.
